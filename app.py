...
app.layout = html.Div([
    html.Div([
        html.H1(children='The Use of Neurophysiological Measurements in Higher Education: '),
...
html.Div([
    ...
    dash_table.DataTable(
        ...
        columns=[
                  ...
                  {"name":'Q3.3. Purpose of the study - Intended and (Reported)', "id":'Q3.3. Reported outcomes (Purposes)'},  
       ...
       {'if': {'column_id': 'Q1.2. Non-neuro Measurements'},
         'width': '40px'},
       {'if': {'column_id': 'Q2.2. Experimental Designs'},
         'width': '20px'},
...
def update_figure(selected_year,selected_measure,selected_construct,n_clicks):
    skip=0
    skipm=0
    skipc=0
...
@app.callback(
    ...
    Input('measure-select', 'value'),
     Input('construct-select', 'value'),
     Input('submit-button', 'n_clicks')])
def update_table(selected_year,selected_measure,selected_construct,n_clicks):
    skip=0
    dff1=df[df['Pub Year'] < 2014]
    dff2=df[df['Pub Year'] < 2014]
    measure=selected_measure
